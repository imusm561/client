!(function (e) {
  ...
  (t.dictionary = Object.assign(t.dictionary || {}, {
    ...
    Dimensions: '尺寸',
    Alignment: '对齐',
    'Align table to the left': '左对齐',
    'Center table': '居中对齐',
    'Align table to the right': '右对齐',
    'Table cell text alignment': '单元格内容对齐',
    'Cell properties': '单元格属性',
    Padding: '外边距',
    'Align cell text to the left': '左对齐',
    'Align cell text to the center': '居中对齐',
    'Align cell text to the right': '右对齐',
    'Justify cell text': '两端对齐',
