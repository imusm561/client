<template>
  <div>
              ...
              <ul class="nav nav-tabs-custom border-bottom-0" role="tablist">
                <li class="nav-item">
                  <a
                    ...
                    role="tab"
                  >
                    {{ $t('layout.navbar.user.dropdown.profil.overview') }}
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#uploads" role="tab">
                    {{ $t('layout.navbar.user.dropdown.profil.uploads') }}
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div class="row">
              <div class="col-xxl-3 col-md-4">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title mb-3">
                      {{ $t('layout.navbar.user.dropdown.profil.overview.info') }}
                    </h5>
                        ...
                        <tbody>
                          <tr>
                            <th class="ps-0" scope="row">
                              {{ $t('layout.navbar.user.dropdown.profil.overview.info.fullname') }}:
                            </th>
                            <td class="text-muted">{{ $store.state.user.data.fullname }}</td>
                          </tr>
                          <tr>
                            <th class="ps-0" scope="row">
                              {{ $t('layout.navbar.user.dropdown.profil.overview.info.phone') }}:
                            </th>
                            <td class="text-muted">{{ $store.state.user.data.phone }}</td>
                          </tr>
                          <tr>
                            <th class="ps-0" scope="row">
                              {{ $t('layout.navbar.user.dropdown.profil.overview.info.email') }}:
                            </th>
                ...
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title mb-4">
                      {{ $t('layout.navbar.user.dropdown.profil.overview.social') }}
                    </h5>
                    <div class="table-responsive">
                ...
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title mb-4">
                      {{ $t('layout.navbar.user.dropdown.profil.overview.skills') }}
                    </h5>
                    <div
                    ...
                    >
                      <span
                        ...
                        v-for="(skill, index) in $store.state.user.data.skills"
                        :key="index"
                      >
                        {{ skill }}
                      </span>
                ...
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title mb-3">
                      {{ $t('layout.navbar.user.dropdown.profil.overview.notifications') }}
                    </h5>
                    <div class="table-responsive">
                      <table class="table table-borderless mb-0">
                        <tbody>
                          <tr>
                            <th class="ps-0" scope="row">
                              {{
                                $t(
                                  'layout.navbar.user.dropdown.profil.overview.notifications.chat',
                                )
                              }}:
                            </th>
                            <td class="form-check form-switch">
                              <input
                                ...
                                type="checkbox"
                                disabled
                                :checked="$store.state.user.data.config.chatNotify"
                              />
                            </td>
                          </tr>
                          <tr>
                            <th class="ps-0" scope="row">
                              {{
                                $t(
                                  'layout.navbar.user.dropdown.profil.overview.notifications.mail',
                                )
                              }}:
                            </th>
                            <td class="form-check form-switch">
                              <input
                                ...
                                type="checkbox"
                                disabled
                                :checked="$store.state.user.data.config.mailNotify"
                              />
                            </td>
                          </tr>
                          <tr>
                            <th class="ps-0" scope="row">
                              {{
                                $t(
                                  'layout.navbar.user.dropdown.profil.overview.notifications.comment',
                                )
                              }}:
                            </th>
                            <td class="form-check form-switch">
                              <input
                                ...
                                type="checkbox"
                                disabled
                                :checked="$store.state.user.data.config.commentNotify"
                              />
                            </td>
                          </tr>
                          <tr>
              ...
              <div class="col-xxl-9 col-md-8">
                <div class="card">
                  <div class="card-body">
                    <h5 class="card-title mb-3">
                      {{ $t('layout.navbar.user.dropdown.profil.overview.about') }}
                    </h5>
                    <p>
                    ...
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title mb-0">
                          {{ $t('layout.navbar.user.dropdown.profil.overview.recentActivities') }}
                        </h4>
                      </div>
                      <div class="card-body">
                        <div class="tab-content text-muted">
                          <div class="profile-timeline">
                            <div class="accordion accordion-flush">
                              ...
                              >
                                ...
                                <div
                                  :id="`recent_item_${item.id}`"
                                  class="accordion-collapse collapse show"
                                >
                                  <div
                                    class="accordion-body ms-2 mb-0 pt-0 pb-0 ps-5 cursor-pointer text-truncate-three-lines fst-italic"
                                    @click="handleViewActivityData(item)"
                                  >
                                    {{ item.data }}
                                  </div>
                                </div>
            ...
            <div class="card">
              <div class="card-header border-0">
                <h5 class="card-title mb-0">
                  {{ $t('layout.navbar.user.dropdown.profil.uploads.files') }}
                </h5>
              </div>
                ...
                <table class="table table-hover table-striped table-borderless align-middle mb-0">
                  <thead class="table-light">
                    <tr>
                      <th scope="col"></th>
                      <th scope="col">
                        {{ $t('layout.navbar.user.dropdown.profil.uploads.name') }}
                      </th>
                      <th scope="col">
                        {{ $t('layout.navbar.user.dropdown.profil.uploads.category') }}
                      </th>
                      <th scope="col">
                        {{ $t('layout.navbar.user.dropdown.profil.uploads.size') }}
                      </th>
                      <th scope="col">
                        {{ $t('layout.navbar.user.dropdown.profil.uploads.uploadDate') }}
                      </th>
                      <th scope="col">
                        {{ $t('layout.navbar.user.dropdown.profil.uploads.action') }}
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr v-for="file in uploads" :key="file.uuid">
                      ...
                      <td
                        class="fs-15 mb-0 cursor-pointer text-secondary text-decoration-underline text-truncate"
                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                            <li
                              ...
                              @click="handleViewFileSource(file.source)"
                            >
    ...
    <button
      id="showActivityDataOffcanvasBtn"
      class="d-none"
