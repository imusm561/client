<template>
  <div class="row g-3">
    <div class="col-md-3 col-sm-6">
      ...
      <input v-model="column.name" type="text" :placeholder="$t('layout.navbar.helper.form.column.config.btnName')" :class="['form-control', errors.name && 'is-invalid']" />
    ...
    <div class="col-md-12">
      ...
      <input v-model="column.cfg.href" type="text" :placeholder="$t('layout.navbar.helper.form.column.config.href')" class="form-control" />
    </div>
    ...
    <div class="col-md-12">
      ...
      <VueSelect v-model="column.tags" multiple :close-on-select="false" taggable push-tags :placeholder="$t('layout.navbar.helper.form.column.config.tags')">
        <template v-slot:no-options="{ search, searching }">
          <template v-if="searching">
            <span v-html="$t('components.vs.search', { search })"></span>
          </template>
