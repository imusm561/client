  ...
  <div class="row g-3">
    ...
    <div class="col-md-3 col-sm-6">
      <label class="form-label">
        {{ $t('layout.navbar.helper.form.column.config.dateFormat') }}
      </label>
      <VueSelect
        ...
        @option:selected="
          () => {
            column.type = ['Y-m-d H:i:S', 'Y-m-d H:i'].includes(column.cfg.dateFormat)
              ? 'datetime'
              : ['Y-m-d'].includes(column.cfg.dateFormat)
              ? 'date'
              : 'time';
          }
        "
